...
import {
  appNameFromHost,
  createHeadInjector as createSharedHeadInjector,
  grokXCreatorHeadTags,
  injectGrokPwaHead as injectSharedGrokPwaHead,
  isDocumentPath,
  isInstallQuery,
  publicAppHost,
  renderWebManifest,
...
function injectGrokPwaHead(html, ctx = {}) {
  return injectSharedGrokPwaHead(html, { cwd: EMPTY_WORKSPACE, ...ctx });
}

function createHeadInjector(ctx = {}) {
  return createSharedHeadInjector({ cwd: EMPTY_WORKSPACE, ...ctx });
}
